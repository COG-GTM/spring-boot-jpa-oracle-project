...
2. Java 17
3. Oracle database 12.1 or newer (ojdbc11 does not support 11g servers)
4. Oracle JDBC driver ojdbc11 (from Maven Central, version managed by the Spring Boot parent)
5. Lombok
6. Maven
7. Hibernate Core 5.6.15.Final
